	...
	<div class="col-12">
		<div class="card">
			<div class="card-body">
				...
				<h4 class="card-title"> PDF Dosyası Yükle</h4>


				<div>
					<form data-url="<?php echo base_url("dosyalar/render_pdf_upload/$item->id");?>" action="<?php echo base_url("dosyalar/pdf_gonder/$item->id");?>" id="dropyukle" class="dropzone">
						<div class="fallback">
