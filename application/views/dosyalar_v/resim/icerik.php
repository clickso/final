	...
	<div class="col-12">
		<div class="card">
			<div class="card-body">
				...
				<div>
					<form data-url="<?php echo base_url("dosyalar/render_resim_upload/$item->id");?>" action="<?php echo base_url("dosyalar/resim_upload/$item->id");?>" id="dropyukle" class="dropzone">
						<div class="fallback">
