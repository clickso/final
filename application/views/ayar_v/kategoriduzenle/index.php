            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="page-title mb-0 font-size-18"><i class="fas fa-arrows-alt"></i>Yeni Kategori Ekle</h4>
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content p-3 text-muted">
                                <?php foreach ($diller as $dil) { ?>
                                    ...
                                    <?php
                                    $items = $this->kategori_iliski_model->cek(
                                        array(
                                    ...
                                    <?php if ($items) {?>
                                        <div class="tab-pane <?php if ($dil->id ==1) { echo "active"; } ;?>" id="<?=$dil->dil_ad;?>" role="tabpanel">
                                            ...
                                            <form action="<?php echo base_url("ayar/kategori_dil_guncelle/$items->id")?>" method="POST" >
