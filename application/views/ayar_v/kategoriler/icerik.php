<div class="col-6">
    <div class="card">
        ...
        <div class="card-body">
            <div class="row mb-3">
                <div class="col-12 col-md-8">  <h5>Sayfa Kategorileri</h5></div>
                <div class="col-12 col-md-4">
                    <a href="<?=base_url("ayar/kategoriekle/2");?>" type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="tooltip" title="" data-bs-original-title="Kategori Ekle">
                        <i class="bx bx-plus-circle"></i> Yeni Kategori Ekle
                    </a>
                </div>
            </div>
            ...
            <table
                ...
                <tr id="siralama-<?php echo $item->id;?>">
                    ...
                    <td>
                        <a
                                href="<?= base_url("ayar/kategoriduzenle/$item->id");?>"
                ...
                <?php
                $alt = $this->kategoriler_model->tumu(
                    array(
...
<div class="col-6 ">
    <div class="card">
        ...
        <div class="card-body">
            <div class="row mb-3">
                <div class="col-12 col-md-8">  <h5>Ürün Kategorileri</h5></div>
                <div class="col-12 col-md-4">
                    <a href="<?=base_url("ayar/kategoriekle/1");?>" type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="tooltip" title="" data-bs-original-title="Kategori Ekle">
                        <i class="bx bx-plus-circle"></i> Yeni Kategori Ekle
                    </a>
                </div>
            </div>
