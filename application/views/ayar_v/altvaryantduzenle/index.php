                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-2">  <img class="img-fluid" src="<?=base_url("uploads/img/$item->img_url");?>" alt=""></div>
                                            <div class="col-10">
                                                    ...
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-12 col-md-9 pt-3">
                                                            <div class="mb-3 row">
                                                                ...
                                                                <div class="col-md-10">
                                                                    <input class="form-control" type="text"  value="<?=$item->title;?>" name="ad" id="example-text-input">
                                                                </div>
                                                            </div>
                                                            <hr>
                                    ...
                                    <?php foreach ($diller as $dil) { ?>
                                        ...
                                        <?php } else { ?>
                                            ...
                                            <div class="tab-pane" id="<?=$dil->dil_ad;?>" role="tabpanel">
                                                ...
                                                <form action="<?php echo base_url("ayar/varyant_dil_kaydet/$dil->id/$item->id/$item->dil_stamp")?>" method="POST" >
                                                    <label for="example-text-input" class="col-md-2 col-form-label">Başlık</label>
