                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            <h4 class="page-title mb-0 font-size-18">Yeni Varyant Ekle</h4>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="<?php echo base_url("ayar/kategoriyevaryantekle/$product_id")?>" method="POST"  enctype="multipart/form-data" >
                                    <div class="mb-3 row">
                                    ...
                                    <a href="<?=base_url("ayar/varyant");?>"  class="btn btn-light" type="submit">Geri Dön</a>
