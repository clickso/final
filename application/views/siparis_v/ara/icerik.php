   ...
   <div class="row">
	...
	<div class="card">
		...
		<div class="card-body">
            ...
            <form action="<?=base_url("siparisler/ara");?>" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-4 float-end" >
                                <div class="mb-3 row">
                                    <div class="col-md-10">
                                        <input class="form-control" name="tarih" type="date"  id="example-date-input">
                                    </div>
                                </div>
                            </div>

                            <div class="col-12 col-md-2"><button class="btn btn-dark w-100" type="submit"> Tarihe Göre Ara</button></div>
			...
			<table id="datatable-buttons"
				...
				<tr>
					<th>Sıraa </th>
                    <th>Düzenle</th>
                    <th width="20%">Müsteri Telefon</th>
                    <th>Siparis No</th>
