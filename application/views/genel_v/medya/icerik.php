	...
	<div class="col-12">
		<div class="card">
			<div class="card-body">
				...
				<div>
					<form data-url="<?php echo base_url($yonlendirme."/render_medya_upload/$item->id");?>" action="<?php echo base_url($yonlendirme."/medya_upload/$item->id");?>" id="dropyukle" class="dropzone">
						<div class="fallback">
