...
class Slider extends MY_Controller {
	...
	public function __construct()
	{
		...
		parent::__construct();
		$this->klasor="genel_v";
        $this->model="slider_detay_model";
		$this->load->model("slider_model");
		$this->load->model("slider_detay_model");

        $this->baslik="Slider";
        $this->stamp_id=00;
        $this->yonlendirme="slider";
	...
	public function dilekle($id)
	{
		...
		$eksikdil=$this->slider_detay_model->cek(
			array(
				'grup_id'=>$id,
				'dil'=>1
			)
        ...
        $gruptakiler=$this->slider_detay_model->tumu(
            array(
                'grup_id'=>$id,
	...
	public function duzenle($id)
	{
		...
		$viewData =new stdClass() ;
		$item=$this->slider_detay_model->cek(
			array(
				'id'=>$id,
	...
	public function medya($id)
	{
		...
		$viewData =new stdClass() ;
		$viewData->item=$item=$this->slider_model->cek(
			array(
				'id'=>$id
			)
		);
	...
	public function kaydet() // Yeni ürün ekleme
	{
		...
		if($form_kontrol) {
			...
			$kayit = $this->slider_model->vt_kayit(
				array(
			...
			if($kayit) {
				...
				foreach ($diller as $dil) {
					$kaydet = $this->slider_detay_model->vt_kayit(
						array(
							"title" => $this->input->post("title"),
	...
	public function guncelle($id)
	{
        ...
        $update = $this->slider_detay_model->vt_guncelle(
            array(
                'id'=>$id
            ),
    ...
    public function grupguncelle($id)
    {
        ...
        $update = $this->slider_model->vt_guncelle(
            array(
                'id'=>$id
            ),
	...
	public function sil($id)
	{
		...
		$tumusil = $this->slider_detay_model->vt_sil(
			array(
				'grup_id'=>$bul->grup_id
			)
			);
